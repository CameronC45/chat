...
public class Message {
	...
	public String toString() {
		return "Message{" + "messageId=" + messageId + ", senderId='" + senderId + '\'' + ", recipientUsername="
				+ recipientUsername + ", content='" + content + '\'' + ", sentAt=" + sentAt + ", chatRoomId="
				+ (chatRoom != null ? chatRoom.getRoomId() : null) + '}';
	}
